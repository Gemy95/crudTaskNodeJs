  ...
  describe('first test', () => {
    it ('register user',(done)=>{  
        chai
            ...
            .send({"fullName": "ali gamal","password": "12345","email": "ali.gamal95880@gmail.coma","age": 15,"phoneNumber": "01017431767","address": "cairo maadi"})
            .then((response) => {
...
describe('third test', () => {
  it('get user devices', (done) => {
    chai
    .request(server)
    .post('/api/devices/getUserDevices')
    .set('content-type', 'application/json')
    .set("token",token)
